const app = Vue.createApp({
    data() {
        return {
            brand: 'medicube',
            productName: 'PDRN - Suero peptídico rosa con ADN de salmón, suero hidratante ultraligero',
            sizes: [
                '1.01 fl oz (paquete de 1)', 
                '3.71 Fl Oz (Pack of 1)'
            ],
            // Datos actualizados con tus imágenes locales del computador
            variants: [
                { 
                    id: 1, 
                    colorName: 'PDRN Suero', 
                    price: 71508, 
                    oldPrice: 82480, 
                    discount: 13, 
